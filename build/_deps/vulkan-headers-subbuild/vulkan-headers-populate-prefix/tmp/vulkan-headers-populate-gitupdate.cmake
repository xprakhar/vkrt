...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "vulkan-sdk-1.3.275.0"
  WORKING_DIRECTORY "C:/Users/prakh/source/repos/dxrt/build/_deps/vulkan-headers-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "vulkan-sdk-1.3.275.0")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("vulkan-sdk-1.3.275.0" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/vulkan-sdk-1.3.275.0")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/prakh/source/repos/dxrt/build/_deps/vulkan-headers-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/prakh/source/repos/dxrt/build/_deps/vulkan-headers-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
